    ...
    <div className="video-player-container" onClick={handleBackgroundClick}>
      ...
      {isEndingTransition && (
        ...
        >
          ...
          <div className={styles.pipDarkOverlay}
          />
          {/* Info del siguiente episodio */}
          {nextEpisode && (
            <div className={styles.pipNextEpisodeContainer}
            >
              <div className={styles.pipUpNextLabel}
              >
                A continuación
              </div>
              <div className={styles.pipNextEpisodeTitle}
              >
                {nextEpisode.title}
              </div>
              <div className={styles.pipNextEpisodeMeta}
              >
                T{nextEpisode.season}:E{nextEpisode.chapter}
              </div>
              <div className={styles.pipNextCountdown}
              >
              ...
              <button
                ...
                } className={styles.pipWatchNowButton}
              >
                Ver ahora
              </button>
            </div>
