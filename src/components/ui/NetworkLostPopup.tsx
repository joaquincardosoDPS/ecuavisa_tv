...
/**
 * Popup no-bloqueante de conexión perdida.
 * Aparece en la esquina superior derecha (bajo el header) cuando se pierde la red.
 * Se oculta automáticamente al reconectarse.
 * No bloquea la interacción del usuario (pointer-events: none) ni el foco TV.
 *
 * Montado a nivel de App.tsx para cubrir TODAS las pantallas
 * incluyendo Login, Register y Seleccionar Perfil (requisito CO-CN-02).
 */
